...
/**
 * Builder implementation to build {@link ConnectionConfig} objects. This is
 * just a convinience class to instantiate {@link ConnectionConfig}. The
 * configuration object can also be instantiates using various constructor
 * provided by the {@link ConnectionConfig} class.
 */
public class ConnectionConfigBuilder {
	...
	public ConnectionConfigBuilder withServerIP(String ip) {
		this.config.setServerIP(ip);
		return this;
	}

	public ConnectionConfigBuilder withServerPort(int port) {
	...
	public ConnectionConfigBuilder withHeartBeat() {
		this.config.setHeartBeatManaged(true);
		return this;
	}
