 ...
 * state (connected/disconnected). A typical example is {@link XMPPPacketReader}
 * whose functioning is dependent on underlying connection status.
 * 
 * @author Yogi
 *
 */
public interface ConnectionStateObserver {
	/**
	 * Invoked when physical connection is established with server. This could
