...
import abs.ixi.client.io.XMPPPacketWriter;

/**
 * A listener interface for entities which are interested in knowing if the
 * connection reconnection is in progress. For example, {@link XMPPPacketWriter}
 * stops trying to write {@link Packet}s on the wire if reconnection is in
 * progress.
 */
