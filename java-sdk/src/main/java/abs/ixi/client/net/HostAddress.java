...
public class HostAddress {
	/**
	 * Default Port of the XMPP server as specified in the RFC
	...
	public HostAddress(String fqdn) {
		this(fqdn, DEFAULT_XMPP_SERVER_PORT);
	}

	public HostAddress(String fqdn, int port) {
		requireNonNull(fqdn, "FQDN can not be null");

		if (port < 0 || port > 65535) {
			throw new IllegalArgumentException("Invalid port " + port + ". Must be in 0-65535 range");
		}
