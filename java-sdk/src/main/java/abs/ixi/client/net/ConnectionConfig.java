...
/**
 * Simple Java Object (POJO) to hold {@link Connection} configurations. Most of
 * the properties here are {@link TCPConnection}; however these configuration
 ...
 * certain properties may be applicable for certain type of connection only.
 * 
 * @author Yogi
 *
 */
public class ConnectionConfig {
	 ...
	 */
	private boolean heartBeatManaged;

	/**
	 * {@link HeartBeatManger} Frequency
	 */
	private Duration heartBeatFrequency;

	// Keeping the access limited to package
	ConnectionConfig() {

	}

	/**
	 * Instansiate a {@code ConnectionConfig} with destination server ip and
	 * port. Only {@link ConnectionConfigBuilder} should make use of this
	 * constructor; rest should use {@link ConnectionConfigBuilder} to
	 * instantiate a connection.
	 * 
	 * @param xmppServerIP destination server ip
	 * @param xmppServerPort destination server port
	 */
	...
	/**
	 * @return destination server port
	 */
	...
	/**
	 * @return frequency of the associated {@link HeartBeatManger}. It's not
	 *         mandatory to attach a {@link HeartBeatManger} to a connection
	 */
	public Duration getHeartBeatFrequency() {
		return heartBeatFrequency;
	}

	void setHeartBeatFrequency(Duration heartBeatFrequency) {
		this.heartBeatFrequency = heartBeatFrequency;
	}

	public boolean isHeartBeatManaged() {
		return heartBeatManaged;
	}

	public void setHeartBeatManaged(boolean heartBeatManaged) {
		this.heartBeatManaged = heartBeatManaged;
	}
