 ...
 * semantics on the connections. Layer-7 protocols such XMPP enforce a mandatory
 * negotiation on the connection before user packets can we read/write on the
 * connection.
 * 
 * @author Yogi
 *
...
public interface NegotiatedConnection extends Connection {
	/**
	 * {@link Connection} implementation with protocol semantics, generally,
