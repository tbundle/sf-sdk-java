 ...
 * <p>
 * The class does not have a public constructor; use {@link ConnectionManager}
 * to instantiate {@code XMPPConnection}.
 * </p>
 * 
 * @author Yogi
 *
...
public class XMPPConnection extends TCPConnection implements NegotiatedConnection {
	...
	/**
	 * A flag to indicate that this connection has been authenticated with
	 * server
	 */
