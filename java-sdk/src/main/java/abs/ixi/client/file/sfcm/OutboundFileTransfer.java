...
public class OutboundFileTransfer extends FileTransfer {
	...
	/**
	 * Callback to no status of file transfer
	 */
	private Callback<String, FailureReason> callback;

	public OutboundFileTransfer(String fileId, File file, ContentType contentType, JID to) {
	...
	public OutboundFileTransfer(String fileId, File file, ContentType contentType, JID to,
			Callback<String, FailureReason> callback) {
		super(fileId, contentType);
		this.file = file;
		this.to = to;
	...
	public Callback<String, FailureReason> getCallback() {
