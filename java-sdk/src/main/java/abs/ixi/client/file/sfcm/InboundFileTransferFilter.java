...
/**
 * A filter for {@link FileTransfer}s. This is an injectable interface
 * which can be used to inject custom logic to filter
 * {@link FileTransfer}s, in case not all the file receive request should
 * be accepted.
 * 
 * @author Yogi
 *
...
public interface InboundFileTransferFilter {
	/**
	 * Accept or reject a {@link FileTransfer}
	 * 
	 * @param request request for file transfer
	 * @return true if the {@link FileTransfer} is accepted otherwise
	 *         false
	 */
