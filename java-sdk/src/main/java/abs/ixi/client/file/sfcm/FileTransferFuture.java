...
import abs.ixi.client.file.sfcm.FileTransfer.Status;

/**
 * File transfer process is asynchronous in nature; therefore any transfer
 * request (inbound/outbound) returns a {@code FileTransferFuture} which can be
 * used to find out if the transfer is complete. It can also be used cancel
 * associated transfer request.
 * <p>
 * The class implementation is <b>thread-safe</b>.
 * </p>
 * 
 * @author Yogi
 *
 */
public class FileTransferFuture {
	 ...
	 * 
	 * @return true if there was an error during this file transfer
	 */
	...
	/**
	 * Cancel the associated file transfer. File transfer can be cancelled if it
	 * is not started yet.
	 * 
	 * @return true if the cancellation was successfull otherwise false
	 */
