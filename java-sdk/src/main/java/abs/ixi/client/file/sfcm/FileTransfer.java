 ...
 * type, sender's JID etc. Client application may choose to accept the request
 * or reject it. {@code FileTransfer} represents a transfer request received on
 * Client.
 * 
 * @author Yogi
 *
...
public abstract class FileTransfer {
	/**
	 * Unique id assigned to this file; this id is also known to server
	 */
	...
	/**
	 * Time at which request was created
	 */
	...
	/**
	 * File transfer may fail due to various reasons. This enum indicate
	 * possible reason for failed file transfer.
	 */
	public enum FailureReason {
		...
		/**
		 * This reason is only applicable for Inbound file transfers. It may
		 * happen that sender could not transfer the file to server
		 */
		...
		/**
		 * If XMPP stream is not ready. Before establishing media stream XMPP
