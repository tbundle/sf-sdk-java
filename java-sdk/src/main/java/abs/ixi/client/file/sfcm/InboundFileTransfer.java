...
public class InboundFileTransfer extends FileTransfer {
	/**
	 * {@link JID} of the sender of the file
	 */
	private JID from;

	/**
	 * {@link Callback} from the application
	 */
	private Callback<File, FailureReason> callback;

	public InboundFileTransfer(JID from, String fileId, Callback<File, FailureReason> callback) {
		super(fileId);
	...
	public InboundFileTransfer(JID from, String fileId, ContentType contentType,
	...
	public Callback<File, FailureReason> getCallback() {
		return callback;
	}
