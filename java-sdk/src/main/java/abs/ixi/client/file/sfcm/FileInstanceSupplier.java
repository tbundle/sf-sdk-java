 ...
 * create {@link File}. For each of {@link FileTransfer} received, SDK uses this
 * interface to acquire a {@link File} instance which is used to write the file
 ...
 * a persistence storage (in most cases it would be disk).
 * 
 * @author Yogi
 *
 */
@FunctionalInterface
public interface FileInstanceSupplier {
	/**
	 * A supplier function to supply a {@link File} instance to SDK which will
	 * be used to write file received.
	 * 
	 * @param fileTransfer FileTransfer
	 * @return File file
	 */
	public File supply(FileTransfer fileTransfer);
