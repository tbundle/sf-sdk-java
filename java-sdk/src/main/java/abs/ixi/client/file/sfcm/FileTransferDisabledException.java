 ...
 * By default, file transfer is disabled in sdk.
 * 
 * @author Yogi
 *
 */
public class FileTransferDisabledException extends RuntimeException {
	private static final long serialVersionUID = -6332342670782546775L;

	public FileTransferDisabledException() {
		super("file transfer is disabled");
	}
}
