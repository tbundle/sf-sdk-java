...
import abs.ixi.client.core.IXIException;
import abs.ixi.client.xmpp.XmppException.ErrorCondition;
...
public interface XMPPResponseCallback {
	 ...
	 * 
	 * @param response stanza which was received in response from server
	 * @param error {@link ErrorCondition}
	 * @throws IXIException if an exception occurs while executing the callback
	 */
	public void onError(Stanza response, ErrorCondition error) throws IXIException;
	 ...
	 * @throws IXIException if an exception occurs while executing the callback
	 */
	public void onSuccess(Stanza response) throws IXIException;
	 ...
	 * @throws IXIException if an exception occurs while executing the callback
	 */
	public void onTimeout() throws IXIException;
