...
public class FailedPacket extends XMPPPacket{
	private static final long serialVersionUID = 3382692964607708842L;
	
	private String xmlns;
	private String reason;
	
	public FailedPacket(Element element) {
		this.xmlns = element.getAttribute("xmlns");
		
		if(CollectionUtils.isNullOrEmpty(element.getChildren())) {
			this.reason = element.getChildren().get(0).val();
		}
	}
