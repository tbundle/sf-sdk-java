...
public interface XMPPNamespace {
	public String STREAM_NAMESPACE = "http://etherx.jabber.org/streams";
	public String USER_REGISTER_NAMESPACE = "jabber:iq:register";
	public String RESOURCE_BIND_NAMESPACE = "urn:ietf:params:xml:ns:xmpp-bind";
	public String SESSION_NAMESPACE = "urn:ietf:params:xml:ns:xmpp-session";
	public String ROSTER_NAMESPACE = "jabber:iq:roster";
	public String TLS_NAMESPACE = "urn:ietf:params:xml:ns:xmpp-tls";
	public String SASL_NAMESAPCE = "urn:ietf:params:xml:ns:xmpp-sasl";
	public String MUC_NAMESPACE = "http://jabber.org/protocol/muc";
	public String MUC_USER_NAMESPACE = "http://jabber.org/protocol/muc#user";
	public String DISCO_NAMESPACE = "http://jabber.org/protocol/disco#items";
	public String INFO_NAMESPACE = "http://jabber.org/protocol/disco#info";
	public String MUC_ADMIN_NAMESPACE = "http://jabber.org/protocol/muc#admin";
	public String MUC_OWNER_NAMESPACE = "http://jabber.org/protocol/muc#owner";
	public String PING_NAMESPACE = "urn:xmpp:ping";
	public String PUSH_NAMESPACE = "stringflow:push";
	public String SM_NAMESPACE = "urn:xmpp:sm:3";
	public String MESSAGE_DELIVERY_RECEIPTS_NAMESPACE = "urn:xmpp:receipts";
	public String CHAT_MARKER_NAMESPACE = "urn:xmpp:chat-markers:0";
	public String CHAT_STATE_NOTIFICATION = "http://jabber.org/protocol/chatstates";
	public String JABBER_X_DATA = "jabber:x:data";
	public String STRINGFLOW_MEDIA_NAMESPACE = "stringflow:media";
	public String VCARD_TEMP_NAMESPACE = "vcard-temp";
	public String VCARD_TEMP_X_UPDATE_NAMESPACE = "vcard-temp:x:update";
	public String JABBER_SEARCH_NAMESPACE = "jabber:iq:search";
