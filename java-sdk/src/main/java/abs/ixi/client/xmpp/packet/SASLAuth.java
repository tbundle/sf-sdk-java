...
public class SASLAuth extends XMPPPacket {
	private static final long serialVersionUID = -3981300622984764476L;

	private String userName;
	private String pwd;
	private SASLMechanism mechanism;

	public SASLAuth(String userName, String pwd, SASLMechanism mechanism) {
	...
	public String xml() {
		if (mechanism == SASLMechanism.PLAIN) {
			return XMPPUtils.getSASLPlainAuth(this.userName, this.pwd);
		}
