...
public class MessageDelay implements MessageContent {
	private static final long serialVersionUID = -2976420947773242354L;

	public static final String XML_ELM_NAME = "delay";
