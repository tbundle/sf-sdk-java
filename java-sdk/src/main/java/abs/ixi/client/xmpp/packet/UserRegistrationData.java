...
public class UserRegistrationData implements Serializable {
	...
	private Set<String> userRegistrationAttributes;

	public UserRegistrationData() {
	}

	public UserRegistrationData(JID jabberId) {
	...
	public void setRegistrationInstruction(String registrationInstruction) {
		this.registrationInstruction = registrationInstruction;
	}

	public Set<String> getUserRegistrationAttributes() {
		return userRegistrationAttributes;
	}

	public void setUserRegistrationAttributes(Set<String> userRegistrationAttributes) {
		this.userRegistrationAttributes = userRegistrationAttributes;
	}
