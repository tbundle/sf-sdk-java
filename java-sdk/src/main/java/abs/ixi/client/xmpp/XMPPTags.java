...
public class XMPPTags {
	public static final String STREAM_TAG = "stream";
	public static final String STREAM_ERROR_TAG = "error";
	public static final String STREAM_FEATURE_TAG = "features";
	public static final String MESSAGE_TAG = "message";
	public static final String SM_ENABLED_TAG = "enabled";
	public static final String SM_RESUMED_TAG = "resumed";
	public static final String IQ_TAG = "iq";
	...
	public static final String STARTTLS_TAG = "starttls";
	...
	public static final String REGISTERED_TAG = "registered";
	...
	public static final String ACK_TAG = "a";
	public static final String ACK_REQUEST_TAG = "r";
