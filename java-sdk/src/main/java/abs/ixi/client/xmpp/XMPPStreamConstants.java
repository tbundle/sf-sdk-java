...
public class XMPPStreamConstants {
	
	public static final String INITIAL_STREAM = "<stream:stream xmlns='jabber:client' to='alterbasics.com' xmlns:stream='http://etherx.jabber.org/streams' version='1.0' from='%s' xml:lang='en'>";
	
	public static final String END_OF_STREAM_NEGITIATION = "<stream:stream xmlns='jabber:client' to='alterbasics.com' xmlns:stream='http://etherx.jabber.org/streams' version='1.0' from='%s' id='%s' xml:lang='en'>";
	
	public static final String AUTH_REQUEST = "<auth xmlns='urn:ietf:params:xml:ns:xmpp-sasl' mechanism='PLAIN'>AGFjZHMAZGVmYXVsdA==</auth>";

	public static final String BIND_REQUEST = "<iq id='%s' type='set'><bind xmlns='urn:ietf:params:xml:ns:xmpp-bind'><resource>%s</resource></bind></iq>";

	public static final String SESSION_REQUEST = "<iq id='%s' type='set'><session xmlns='urn:ietf:params:xml:ns:xmpp-session'/></iq>";

	public static final String ROSTER_QUERY_REQUEST = "<iq id='%s' type='get'><query xmlns='jabber:iq:roster'></query></iq>";
	
	public static final String PRESENCE_REQUEST  = "<presence id='%s'><c xmlns='http://jabber.org/protocol/caps' hash='sha-1' node='http://www.igniterealtime.org/projects/smack' ver='NfJ3flI83zSdUDzCEICtbypursw='/></presence>";

	public static final String MESSAGE = "<message from='%s' to='%s'><body>%s</body></message>";
