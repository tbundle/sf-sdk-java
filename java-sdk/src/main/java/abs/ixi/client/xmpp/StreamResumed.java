 ...
 *
 */
public class StreamResumed extends XMPPPacket {
	private static final long serialVersionUID = -6449859754433695387L;

	private String xmlns;
	private String prevStreamId;
	private int prevHandledPacketCount;

	public StreamResumed(Element element) {
		this.xmlns = element.getAttribute("xmlns");
		this.prevStreamId = element.getAttribute("previd");

		if (element.getAttribute("h") != null) {
			this.prevHandledPacketCount = Integer.parseInt(element.getAttribute("h"));
		}
	}
	...
	public String getPrevStreamId() {
		return prevStreamId;
	}

	public void setPrevStreamId(String streamId) {
