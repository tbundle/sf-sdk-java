 ...
 * <p>
 * As sdk is compiled with target version 1.7, we can not make use of functional
 * interface offered by Java8. This is interface is drop-in substitute for
 * Function interface offered in Java8
 * </p>
 */
