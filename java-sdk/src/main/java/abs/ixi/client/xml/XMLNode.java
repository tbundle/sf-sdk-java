...
public interface XMLNode extends Cloneable, Serializable {
	 ...
	 * 
	 * @return cloned XMLNode instance
	 */
	 ...
	 * 
	 * @return String value after stringifying this XMLNode
	 */
	 ...
	 * 
	 * @return String value with all the children
	 */
