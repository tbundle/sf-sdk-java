...
/**
 * Although any {@link Runnable} or {@link java.util.concurrent.Callable} can be
 * submitted to {@link TaskExecutor} for execution but {@code Task} offer better
 * control during execution. A task intance can be submited to
 * {@link TaskExecutor} with preExecute and postExecute hooks defined, if
 * needed.
 */
