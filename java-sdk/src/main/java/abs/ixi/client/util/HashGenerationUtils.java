...
public class HashGenerationUtils {
	...
	public static String generateSHA1Hash(File file) throws IOException, NoSuchAlgorithmException {
		return generateFileHash(file, "SHA-1");
	}

	public static String generateFileHash(File file, String algorithm) throws IOException, NoSuchAlgorithmException {
		try (FileInputStream fis = new FileInputStream(file)) {
			...
			return encodeToHexString(hashedBytes);

		}
	}

	public static String generateBytesHash(byte[] bytes, String algorithm) throws NoSuchAlgorithmException {
		MessageDigest digest = MessageDigest.getInstance(algorithm);
