...
public final class FileUtil {
	...
	/**
	 * Create file of given name to given path. If directory is not available
	 * first it creates that path directories.
	 * 
	...
	public static File createFile(String filePath, String fileName) {
		LOGGER.info("Creating file in dir " + filePath + " with file name" + fileName);
	...
	public static void deleteFile(String filePath, String fileName) {
		LOGGER.info("Deleting file in dir " + filePath + " with file name" + fileName);
	 ...
	 */
	public static boolean persistObjectToFile(File file, Object obj) {
		try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(file))) {
			LOGGER.info("Persisting Object " + obj + " to file " + file.getName());
			...
			LOGGER.warning("Failed to persist Object " + obj + " to file " + file.getName() + e);
	...
	/**
	 * Persists given Object to given file path and given file name. If file is
	 * not available firstly it will create file.
	 * 
	 * @param filePath filePath
	 * @param fileName fileName
	 * @param obj obj
	 * @return boolean true or false
	 */
	public static boolean persistObjectToFile(String filePath, String fileName, Object obj) {
		File file = createFile(filePath, fileName);
		return persistObjectToFile(file, obj);
	}
	...
	public static Object readObjectFromFile(File file) {
		...
		try (ObjectInputStream ois = new ObjectInputStream(new java.io.FileInputStream(file))) {
			LOGGER.info("Reading Object from file " + file.getName());
			return ois.readObject();

		} catch (Exception e) {
			LOGGER.warning("Failed to read Object from file " + file.getName() + e);
		}
	...
	public static byte[] getFileBytes(File file) throws IOException {
		try (BufferedInputStream bis = new BufferedInputStream(new FileInputStream(file))) {
			...
			if (readBytes != buffer.length) {
				throw new IOException("Failed to read file properly");
			}
