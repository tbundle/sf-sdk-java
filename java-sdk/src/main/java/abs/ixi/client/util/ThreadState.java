 ...
 * reasons, Java Executor service can not deployed to replace them. A thread
 * passes through various states and the state manipulation must be
 * synchronized.
 * <p>
 * {@code ThreadState} must not be confused with the Java defined states of a
