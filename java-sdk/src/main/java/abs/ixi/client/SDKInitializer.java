...
public interface SDKInitializer {
	...
	/**
	 * @return {@link ResponseCorrelator} instance created during initialization
	 */
	public ResponseCorrelator getResponseCorrelator();

	/**
	 * @return {@link XMPPStreamManager} instance created during initialization
	 */
	public XMPPStreamManager getStreamManager();

	/**
	 * @return {@link UserManager} instance created during initialization
	 */
	public UserManager getUserManager();

	/**
	 * @return {@link ChatManager} instance created during initialization
	 */
	public ChatManager getChatManager();

	/**
	 * @return {@link PresenceManager} instance created during initialization
	 */
	public PresenceManager getPresenceManager();

	/**
	 * @return {@link UndeliveredStanzaManager} instance created during
	 *         initialization
	 */
