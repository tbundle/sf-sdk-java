 ...
 * SDK. Any class which implements {@link Initializable} can potentially throw
 * this exception to indicate an error during {@link Initializable#init()} call.
 * 
 * @author Yogi
 *
 */
public class InitializationErrorException extends Exception {
	private static final long serialVersionUID = -4512707180226541137L;

	public InitializationErrorException(String msg) {
		super(msg);
	}

	public InitializationErrorException(Exception cause) {
		super(cause);
	}

	public InitializationErrorException(String msg, Exception cause) {
		super(msg, cause);
	}
}
