...
public interface EventBus {
    /**
     * Fires event to all the {@link EventListener}s registered with this event
     * bus.
     * 
     ...
     * @param type generic param
     */
    public <T extends Event> void addListener(Class<T> type, EventListener<T> listener);

    /**
     * Adds {@link EventHandler} to receive given type of {@link EventType}.
     * @param handler EventHandler
    ...
    /**
     * Removes {@link EventHandler} or handler of given type.
     * @param handler EventHandler
     * @param <T> generic param
     */
