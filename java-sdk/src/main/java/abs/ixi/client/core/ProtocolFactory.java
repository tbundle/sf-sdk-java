...
public class ProtocolFactory {
	private static XMPPProtocol xmppProtocol;

	/**
	 * @return Singleton {@link XMPPProtocol} instance
	 */
	public synchronized static XMPPProtocol xmppProtocolInstance() {
		if (xmppProtocol == null) {
			xmppProtocol = new XMPPProtocol();
		}
	...
	/**
	 * Optionally force instantiate {@link XMPPProtocol}
	 * 
	 * @param newInstance flag to indicate if the protocol should be
	 *            instantiated again
	 * @return {@link XMPPProtocol} instance
	 */
	public synchronized static XMPPProtocol xmppProtocolInstance(boolean newInstance) {
		if (newInstance) {
			xmppProtocol = new XMPPProtocol();
		}

		return xmppProtocolInstance();
	}
