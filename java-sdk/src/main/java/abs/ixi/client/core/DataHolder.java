...
public interface DataHolder {
	 ...
	 * 
	 * @param key key for which value will be returned
	 * @return value
	 */
	 ...
	 * @param val value
	 * @param key key
	 * @return given value if there is no value stored already for the given key
	 *         otherwise the previous value which will be overwritten
	 */
