...
/**
 * {@code Event} represents SDK generated events. These events are generally
 * fired through {@link EventBus} to all the subscribed {@link EventListener}
 */
public class Event {
	...
	public Event(EventType type, Object source) {
		this(type, source, Calendar.getInstance());
	}

	public Event(EventType type, Object source, Calendar createTime) {
		this.type = type;
		this.source = source;
	...
	/**
	 * {@code EventType} indicates type of the event allowing the default
	 * {@link Event} implementation to be used for multiple event types.
	 */
	public enum EventType {
		...
		MEDIA_SENT_TO_SERVER,

		MEDIA_TRANSFER_FAILED,

		MEDIA_RETRIVAL_FAILED,

		MEDIA_RETRIVAL_PRCESSESED,
