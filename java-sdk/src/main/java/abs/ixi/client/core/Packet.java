 ...
 * server to a user agent. Currently the interface has no behaviour exposed;
 * therefore it acts as a Marker interface; however the intention is not to keep
 * it as a marker interface. In future, the interface may have behaviours.
 */
public interface Packet extends Writable, Serializable {
	/**
	...
	/**
	 * @return true if packet is one of ({@link Message}, {@link Presence},
	 *         {@link IQ}).
	 */
