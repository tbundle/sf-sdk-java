...
/**
 * {@code Context} holds contextual data for current state of SDK. The
 * {@code Context} is loaded into the memory at startup and remains until it is
 * reset/removed/destroyed.
 */
public interface Context extends DataHolder {
	/**
	 * @return {@link EventBus} instance from the {@code Context}
	 */
	public EventBus getEventBus();

	/**
	 * Resets {@code Context}. Resetting Context will flush all the data held by
