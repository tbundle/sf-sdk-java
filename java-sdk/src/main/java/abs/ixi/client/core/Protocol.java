...
/**
 * Base interface for supported protocols. As of now, only XMPP protocol is
 * supported.
 */
public interface Protocol<PACKET> {
	 ...
	 */
	public void inforceInbound(PACKET packet) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public void infourceOutbound(PACKET packet) throws Exception;
