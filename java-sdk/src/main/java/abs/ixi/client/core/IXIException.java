...
import abs.ixi.client.xmpp.XmppException;

/**
 * Base Exception for all the cases which are not covered by XMPP protocol and
 * are not resulted due to network level glitch.
 * 
 * Exceptions originated from network layer are represented by
 * {@link NetworkException} while XMPP protocol related exceptions are of type
 * {@link XmppException}
 */
public class IXIException extends Exception {
	private static final long serialVersionUID = 1L;
	
	public IXIException(Exception e) {
		super(e);
	}
	
	public IXIException(String msg) {
		super(msg);
	}
	
	public IXIException(String msg, Exception e) {
		super(msg, e);
	}
