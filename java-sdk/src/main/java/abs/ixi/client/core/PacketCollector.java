...
/**
 * An interface to define an entity which can collect generated packets. The
 * {@link PacketCollector} interface can be used to define custom Packet
 * consumers.
 * 
 * <p>
 * There could be many packet collectors; therefore one packet may get processed
 * by multiple packet collectors; therefore, developers must ensure that packet
 * is considered read-only, although it is not read-only by design.
 * </p>
 */
public interface PacketCollector {
	/**
	 * This collector takes the given packet. The collector may employ further
	 * filtering and may decide to ignore/drop this packet.
	 * 
	 * @param packet packet instance to be collected
	 */
