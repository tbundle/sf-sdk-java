...
public interface Writable {
     ...
     * @param socket network socket on which bytes will be written
     ...
     * 
     * @return no of bytes written
     * @param socketChannel network socket channel 
     * @throws IOException if any IO error occurred while writing bytes 
     */
     ...
     * 
     * @return no of bytes written
     * @param os {@link OutputStream} insatnce
     * @throws IOException if IO error occurrs
     */
