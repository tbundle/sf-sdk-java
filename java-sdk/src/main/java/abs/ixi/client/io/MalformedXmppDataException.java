...
public class MalformedXmppDataException extends Exception{
	private static final long serialVersionUID = 1L;

	public MalformedXmppDataException() {
		super();
	}
	
	public MalformedXmppDataException(Exception e) {
		super(e);
	}

	public MalformedXmppDataException(String msg) {
		super(msg);
	}
