...
public class ImageContent extends AbstractContent {
	public ImageContent(String filePath, ContentType type) {
		this(new FileContentSource(filePath), type);
	}

	public ImageContent(File file, ContentType type) {
		this(new FileContentSource(file), type);
	}

	public ImageContent(InputStream is, ContentType type) {
		this(new InputStreamContentSource(is), type);
	}

	public ImageContent(byte[] bytes, ContentType type) {
		this(new ByteArrayContentSource(bytes), type);
	}

	public ImageContent(ContentSource contentSource, ContentType type) {
		this(contentSource, type.getMimeType());
	}

	public ImageContent(ContentSource contentSource, String type) {
		super(contentSource, type);
	}
