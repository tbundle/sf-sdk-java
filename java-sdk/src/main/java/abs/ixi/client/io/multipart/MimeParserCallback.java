...
/**
 * {@link MultipartParser} is an event based parser which dispatched events
 * while processing mime stream. This interface is a callback interface to
 * receive those events and process them.
 * 
 * @author Yogi
 *
 */
public interface MimeParserCallback {
	/**
	 * A callback when parser has finished parsing mime headers for a
	 * {@link MultipartMessage}. The method argument contains the
	 * {@link MultipartMessage} under construction.
	 * 
	...
	/**
	 * A callback when parser has finished parsing a {@link MultipartMessage}.
	 * The message is supplied in the method argument
	 * 
	 * @param message message
	 */
	...
	/**
	 * A parser callback when parse has finished parsing multipart header for a
	 * {@link Multipart} of a {@link MultipartMessage}.
	 * 
	...
	/**
	 * A callback when parser has finished parsing a {@link Multipart} of a
	 * {@link MultipartMessage}.
	 * 
	 * @param multipart multipart
	 */
