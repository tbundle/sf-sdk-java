...
public interface ByteProcessor {
	 ...
	 * 
	 * @param switchOver half-built packet from previous processor
	 */
	 ...
	 * Process byte stream; processing a byte stream typically involves
	 * encoding, parsing and building a packet. Therefore, the method may throw
	 * {@link ParserException} or {@link MalformedStreamException} a
	 * 
	 * @param networkData networkData
	 * @param length length
	 * @throws Exception Exception
	 ...
	 * {@link ByteSource}. It may happen that before a byte processor finishes
	 * processing a byte chunk, byte processing is taken over by another
	 * {@link ByteProcessor}. In this case, the active byte processor will
