...
import abs.ixi.client.lang.ByteSource.ByteRange;
...
public interface LineReader<T> {
	...
	/**
	 * Reads a line from the {@link ByteSource}
	 * 
	 * @param src src
	 * @return T generic 
	 */
	public T readLine(ByteSource src);
	 ...
	 */
	public T readLine(ByteSource src, boolean skipBlankLines);

	/**
	 * {@code Line} class captures information to represent a line within a
	 * {@link ByteSource}
	 */
	public static class Line extends ByteRange {
