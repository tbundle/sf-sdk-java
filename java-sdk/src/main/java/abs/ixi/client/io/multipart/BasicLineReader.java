 ...
 */
public class BasicLineReader implements LineReader<abs.ixi.client.io.multipart.LineReader.Line> {

	@Override
	public Line readLine(ByteSource src) {
		return readLine(src, false);
	}

	@Override
	public Line readLine(ByteSource src, boolean skipBlankLines) {
