...
/**
 * A contract to receive packets from {@link ByteProcessor} implementations.
 * Typically an {@link InputStreamProcessor} implementation uses this contract
 * to collect generated packets from {@link ByteProcessor}.
 */
public interface PacketReceiver<PACKET> {
	/**
	 * Receive a packet from a {@link ByteProcessor}. This packet may not be
	 * fully constructed; in which case it will be passed on to another
	 * {@link ByteProcessor}.
	 * 
	 * @param packet packet
	 * @return true if the {@link ByteProcessor} should quit processing;
	 *         otherwise false
	 *         
