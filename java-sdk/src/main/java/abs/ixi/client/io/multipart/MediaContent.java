...
public class MediaContent extends AbstractContent {
	public MediaContent(File file, String contentType) {
		this(new FileContentSource(file), contentType);
	}

	public MediaContent(String filePath, ContentType contentType) {
		this(new FileContentSource(filePath), contentType);
	}

	public MediaContent(File file, ContentType contentType) {
		this(new FileContentSource(file), contentType);
	}

	public MediaContent(InputStream is, ContentType contentType) {
		this(new InputStreamContentSource(is), contentType);
	}

	public MediaContent(byte[] bytes, ContentType contentType) {
		this(new ByteArrayContentSource(bytes), contentType);
	}

	public MediaContent(ContentSource contentSource, ContentType contentType) {
		this(contentSource, contentType.getMimeType());
	}

	public MediaContent(ContentSource contentSource, String contentType) {
		super(contentSource, contentType);
	}

	public MediaContent(ContentSource source) {
		super(source);
	}
}
