...
public final class MultipartMessageBuilder {
	...
	public MultipartMessageBuilder() {
		this.message = new MultipartMessage();
	}

	public MultipartMessageBuilder withMessageHeader(String key, String value) {
		this.message.addHeader(key, value);
		return this;
	}

	public MultipartMessageBuilder withBoundary() {

		return this.withMessageHeader(BOUNDARY, MultipartMessage.generateBoundary());
	}

	public MultipartMessageBuilder withMediaId(String mediaName) {

		return this.withMessageHeader(MEDIA_ID, mediaName);
	}

	public MultipartMessageBuilder withFromJID(JID from) {

		return this.withMessageHeader(FROM, from.toString());
	}

	public MultipartMessageBuilder withStreamId(String streamId) {

		return this.withMessageHeader(SID, streamId);
	}

	public MultipartMessageBuilder withMultipart(Multipart multipart) {
		this.message.addMultiPart(multipart);
		return this;
	}

	public MultipartMessageBuilder withTextContent(String contentName, String text, ContentType type) {
		Multipart multipart = new Multipart(contentName, new TextContent(text, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withMediaContent(String contentName, String filePath, ContentType type) {
		Multipart multipart = new Multipart(contentName, new MediaContent(filePath, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withMediaContent(String contentName, File file, ContentType type) {
		Multipart multipart = new Multipart(contentName, new MediaContent(file, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withMediaContent(String contentName, InputStream is, ContentType type) {
		Multipart multipart = new Multipart(contentName, new MediaContent(is, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withMediaContent(String contentName, byte[] bytes, ContentType type) {
		Multipart multipart = new Multipart(contentName, new MediaContent(bytes, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withImageContent(String contentName, String filePath, ContentType type) {
		Multipart multipart = new Multipart(contentName, new ImageContent(filePath, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withImageContent(String contentName, File file, ContentType type) {
		Multipart multipart = new Multipart(contentName, new ImageContent(file, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withImageContent(String contentName, InputStream is, ContentType type) {
		Multipart multipart = new Multipart(contentName, new ImageContent(is, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withImageContent(String contentName, byte[] bytes, ContentType type) {
		Multipart multipart = new Multipart(contentName, new ImageContent(bytes, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withAudioContent(String contentName, String filePath, ContentType type) {
		Multipart multipart = new Multipart(contentName, new AudioContent(filePath, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withAudioContent(String contentName, File file, ContentType type) {
		Multipart multipart = new Multipart(contentName, new AudioContent(file, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withAudioContent(String contentName, InputStream is, ContentType type) {
		Multipart multipart = new Multipart(contentName, new AudioContent(is, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withAudioContent(String contentName, byte[] bytes, ContentType type) {
		Multipart multipart = new Multipart(contentName, new AudioContent(bytes, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withVideoContent(String contentName, String filePath, ContentType type) {
		Multipart multipart = new Multipart(contentName, new VideoContent(filePath, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withVideoContent(String contentName, File file, ContentType type) {
		Multipart multipart = new Multipart(contentName, new VideoContent(file, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withVideoContent(String contentName, InputStream is, ContentType type) {
		Multipart multipart = new Multipart(contentName, new VideoContent(is, type));
		return this.withMultipart(multipart);
	}

	public MultipartMessageBuilder withVideoContent(String contentName, byte[] bytes, ContentType type) {
		Multipart multipart = new Multipart(contentName, new VideoContent(bytes, type));
		return this.withMultipart(multipart);
	}
