...
public class ProtocolException extends Exception {
	...
	private Violation vilation;

	public ProtocolException(Violation vilation) {
		super();
		this.vilation = vilation;
	}

	public ProtocolException(Violation vilation, String msg) {
		super(msg);
		this.vilation = vilation;
	}
	
	public Violation getVilation() {
		return this.vilation;
	}
