...
public abstract class AbstractContentSource implements ContentSource {
	 ...
	 * 
	 * @param is
	 *            {@link InputStream} instance from which data will be read
	 * @param channel
	 *            {@link SocketChannel} on which data will be written to
	 * @return number of bytes written to {@link SocketChannel}
	 * @throws IOException
	 *             if any IO error occurs during writing
	 */
	 ...
	 * 
	 * @param bytes
	 *            content to be drained onto {@link SocketChannel}
	 * @param channel
	 *            {@link SocketChannel} on which content will be written
	 * @return number of bytes written
	 * @throws IOException
	 *             if IO error occurs during write
	 */
	 ...
	 * 
	 * @param bytes
	 *            byte array with content
	 * @param offset
	 *            index of first byte to be read
	 * @param length
	 *            number of bytes to be read starting from offset index
	 * @param channel
	 *            {@link SocketChannel} on which content to be written
	 * @return number of bytes written
	 * @throws IOException
	 *             if IO error occurs during write
	 */
	 ...
	 *            {@link InputStream} instance from which data will be read
	 * @param socket
	 *            {@link Socket} on which data will be written to
	 * @return number of bytes written to {@link SocketChannel}
	 * @throws IOException
	 *             if any IO error occurs duriing writting
	 */
	 ...
	 * 
	 * @param is
	 *            inputstream from which content will be read
	 * @param os
	 *            outputstream on which content will be written
	 * @return number of bytes written on to the outputstream
	 * @throws IOException
	 *             if IO error during writting or reading
	 */
	 ...
	 *            byte array with content
	 * @param socket
	 *            {@link Socket} on which content will be written
	 * @throws IOException
	 *             if IO error occurs
	 */
	 ...
	 *            byte array with content
	 * @param os
	 *            {@link OutputStream} on which content will be written
	 * @throws IOException
	 *             if IO error occurs
	 */
	 ...
	 *            byte array with content
	 * @param offset
	 *            starting index of the array from which content will be read
	 * @param length
